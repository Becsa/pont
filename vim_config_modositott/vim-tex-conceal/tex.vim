...
"sajat syntaxok
  ...
  syn match texMathSymbol '\\micro\>' contained conceal cchar=μ
...
" Include space after greek letters:
  ...
  " pont kiegeszites
  " syn match texMathSymbol '\\dot{q}' contained conceal cchar=q̇
  " syn match texMathSymbol '\\dot{Q}' contained conceal cchar=Q̇
  ...
  syn region texBoldMathText matchgroup=texStatement start='\\\(mathbf\|bm\|symbf\|matrix\|vec\){' end='}' concealends contains=@texMathZoneGroup containedin=texMathMatcher
